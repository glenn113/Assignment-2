...
Glenn Roberts-Cyber security needs to constantly evolve to keep up with the increasing sophistication new methods of cyber-attacks. The war between security experts charged with the responsibility of protecting information and cyber-criminals who threaten to compromise the integrity of data for different entities has become a war of evolution and Darwinism with only the best and the ones willing to innervate and stay ahead of the competition surviving. For instance, as soon as white hat hackers counter one form of malicious behaviour using encryption tools, there is the almost immediate development of yet another malevolent form of threat for information systems. One of the technologies that is helping in this fight is Hardware authentication. 

Many people’s passwords and usernames are weak. This makes it easy for hackers to infiltrate computer systems and steal sensitive data, some people don’t even change their passwords or usernames from the default. For example, recently an Australian defence force contractor was hacked due to passwords and usernames being too weak, the admin password, to enter the company’s web portal, was ‘admin’ and the guest password was ‘guest’. However, this is about to change, technology experts have developed a solution in the user authentication process with a new Core vPro processor that belongs to the sixth generation of processors. The core vPro can combine different hardware components with enhanced factors simultaneously for user identity validation purposes. 

Another relatively new technology that has been brought onto the scene is Cloud technology bringing with it new ways to store and transfer information. The cloud is set to have a significant impact on the transformation of systems security technology. More business enterprises and government agencies have embraced cloud technology to store the vast amounts of information that they generate on a daily basis. There will be more approaches to information systems security that will be developed for use in the cloud. Techniques for on premise data storage will be moved to the cloud. Components such as virtualized intrusion detection and prevention systems, virtualized firewalls and virtualized systems security will now be used from the cloud as opposed to the traditional forms. For instance, both private and public entities have doubled up their data centre security by the use of IaaS services, such as Fire host and Amazon. Another perfect example of certified secure enough services that are based on the cloud is the GSA FedRAMP, which makes it easier for the small- to medium-sized business enterprises to have a data security centre that is above average.

Lastly there has been major development in deep learning.  Some technologies are encompassed in deep learning, such as machine learning and artificial intelligence. There is a large deal of enthusiasm for purposes of systems security in these technologies. Deep learning, just like behaviour analytics, focuses on anomalous behaviour. Whenever AI and machine learning systems are fed with the right data regarding potential systems security threats, they can make decisions on how to prevent hacks depending on their immediate environment without any human input. This AI can eventually surpass human judgment and ability therefore making human interaction obsolete.
...
The development of these different types of ways we tackle cybersecurity will make it easier or at least more efficient. However, there is always going to be a new cyber threat or a new way to hack into unauthorised systems, yes, we have new technologies but they aren’t going to fix the problem long term and we need to keep up to date.  This advancement in cyber security can have major impacts on other industries such as healthcare and energy. These new changes will make these industries more reliable and safe especially since these industries are so crucial to society, more so healthcare with recent cybersecurity attacks threatening to bring down or disrupt the system
One problem society is facing is with these new developments in IT is some jobs or some industries may become obsolete. Some may argue that it will create more jobs for example with AI yes it may make some jobs obsolete but to make AI we need programmers and software engineers etc, but there is some debate to whether or not there will be a net gain in jobs or a net loss and it is very dependable on the industry. Regardless, AI and other advancements will make some jobs obsolete in the cyber security industry creating displacement and in some cases reskilling to keep up with the ever-changing times.  This therefore may leave some people unemployed for a duration of time while they transition to other jobs. 
...
Another advancement/improvement we would like to make is in AI. Today, most smart home devices use monition sensors to figure out if someone has for example moved into the bathroom or is trying to break in to the home. This does have major problems; motion censors are not always reliable and can be triggered a number of ways for example an animal going past or even heavy vibrations. With this new system, there is an AI consciously watching and monitoring the cameras/motion sensors therefore it can identify more accurately human beings. This can be taken one step further. Smart home devices use pre-programmed AI to respond to user’s voice commands. What we want to do is not develop a device but a friend/assistant that helps you around the house and knows your likes and dislikes and someone you can have a meaningful conversation with. 

A clear concern some people might have with this idea is security. Having a centralised system could mean that hackers can infiltrate the system easier. However, this can be avoided by taking the necessary precautions there the system will be on a closed network with no connection to the internet or other computers, yes this may limit functionality but it’s for the sake of security. Some devices may be able to connect to the internet but will have to be disconnect from the centralised network. Also, the AI will have to have some limitations especially on improvisation to make sure it doesn’t go rogue.

We also want to make the user be able to interact with their home without actually being in it. We want the user to use his/her smart phone to have full access to their house. This includes access to cameras, doors and a range of appliances. This outside connectivity can be pushed further for example to the car and having access to your house from your car. However, this can compromise security so maybe not a smart phone but just a connect device would work.

The next generation smart home solves many problems. For example, extra security, having AI able to detect intrudes the AI can act independently to try and stop the threat for example closing all windows and locking all doors will revolutionise the sense of secuirt7y we feel in our homes. And for the physically incapacitated this new concept can make it easier for them to interact with their home for example if someone broke their leg and couldn’t turn on the light or turn on the TV or open a door properly or interact physically with anything by touch then they can do that with their voice and with the assistance of the home AI the possibilities are endless. 
...
Glenn
As a group, we have had our ups and downs. We have had members not showing up to tutorials due to illness but in the face of adversity we have pushed through and worked really hard. I personally could have maybe started this earlier but considering some members were away it was difficult to split the work up among ourselves. GitHub was a slight pain to use mainly because it was new to me.  Obviously, the GitHub contribution log is not a great way to see how much work everyone has put in. This is because you can’t see exactly what people have contributed so for an assessor it is difficult and more contributions doesn’t necessary mean more work done and to be honest its literally impossible, there is no way on GitHub to accurately see how much work each member did. Want I though was surprising was how well we recovered and bounced back from the setbacks, I thought we wouldn’t be in this position by the end. 
